...
blueskyId: '3mmerbfiggk2l'
---

At the startup where I work, the core product is a platform for retrieval-augmented classification. Customers provide labeled data, which is embedded and stored to guide a classifier. The biggest lever for adapting those classifiers to a customer’s domain is usually finetuning the [embedding model](https://docs.orcadb.ai/guides/embedding-models/).
